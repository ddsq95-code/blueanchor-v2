...
def init_db(db: Session = Depends(get_db)):
    ...
    # 💡 회원님의 원본 데이터 복구 완료 + available_seats(잔여석) 추가!
    mock_boats = [
        {
            "name": "블루오션호", "region": "충남 보령시", "port": "오천항",
            "tonnage": "9.77t", "max_guests": 22, "available_seats": 22, "price": 150000,
        ...
        },
        {
            ...
            "tonnage": "7.31t", "max_guests": 18, "available_seats": 18, "price": 100000,
        ...
        },
        {
            ...
            "tonnage": "9.77t", "max_guests": 20, "available_seats": 20, "price": 140000,
        ...
        },
        {
            ...
            "tonnage": "5.00t", "max_guests": 12, "available_seats": 12, "price": 180000,
        ...
        },
        {
            ...
            "tonnage": "7.93t", "max_guests": 16, "available_seats": 16, "price": 80000,
        ...
        },
        {
            ...
            "tonnage": "9.77t", "max_guests": 20, "available_seats": 20, "price": 120000,
        ...
        },
        {
            ...
            "tonnage": "9.77t", "max_guests": 18, "available_seats": 18, "price": 160000,
        ...
        },
        {
            ...
            "tonnage": "9.77t", "max_guests": 22, "available_seats": 22, "price": 110000,
